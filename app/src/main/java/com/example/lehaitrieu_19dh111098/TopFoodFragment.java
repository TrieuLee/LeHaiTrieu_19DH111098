...
public class TopFoodFragment extends Fragment implements TopFoodAdapter.OnFoodItemClickListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvTopFood = view.findViewById(R.id.rvTopFoods);
        topFoodAdapter = new TopFoodAdapter(foods, this);
        ...
        dTopFood =fDb.getReference();

        Query qRestaurant = dTopFood.child("foods");
