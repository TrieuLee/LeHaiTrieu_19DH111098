...
import com.example.lehaitrieu_19dh111098.LocationServiceTask;
import com.example.lehaitrieu_19dh111098.R;
...
public class AddressFragment extends Fragment {
    TextInputEditText tvAddress, tvMobile, tvConfirm;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(v -> {
            if (tvAddress.getText().toString().isEmpty() ){
                tvAddress.setError("Không được bỏ trống");
                return;

            }
            if (tvMobile.getText().toString().isEmpty() ){
                tvMobile.setError("Không được bỏ trống");
                return;
